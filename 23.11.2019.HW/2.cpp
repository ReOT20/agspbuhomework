...
/*Алгоритм эффективен, т.к. мы переюираем не 10^n значений, а 10^(n/2), 
т.к. используем перебор только первой части палиндрома, 
а вторая получается из переворота первой*/
